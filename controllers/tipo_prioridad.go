...
type TipoPrioridadController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoPrioridadController) URLMapping() {
...
// @Param	body		body 	models.TipoPrioridad	true		"body for TipoPrioridad content"
// @Success 201 {int} models.TipoPrioridad
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *TipoPrioridadController) Post() {
	var v models.TipoPrioridad
	v.FechaCreacion = time_bogota.TiempoBogotaFormato()
	v.FechaModificacion = time_bogota.TiempoBogotaFormato()
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoPrioridad(&v); err == nil {
...
// @Success 200 {object} models.TipoPrioridad
// @Failure 404 not found resource
// @router /:id [get]
func (c *TipoPrioridadController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoPrioridadById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 404 not found resource
// @router / [get]
func (c *TipoPrioridadController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllTipoPrioridad(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *TipoPrioridadController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoPrioridad{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateTipoPrioridadById(&v); err == nil {
...
// @Failure 404 not found resource
// @router /:id [delete]
func (c *TipoPrioridadController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoPrioridad(id); err == nil {
