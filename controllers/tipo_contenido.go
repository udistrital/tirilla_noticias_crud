...
type TipoContenidoController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoContenidoController) URLMapping() {
...
// @Param	body		body 	models.TipoContenido	true		"body for TipoContenido content"
// @Success 201 {int} models.TipoContenido
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *TipoContenidoController) Post() {
	var v models.TipoContenido
	v.FechaCreacion = time_bogota.TiempoBogotaFormato()
	v.FechaModificacion = time_bogota.TiempoBogotaFormato()
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoContenido(&v); err == nil {
...
// @Success 200 {object} models.TipoContenido
// @Failure 404 not found resource
// @router /:id [get]
func (c *TipoContenidoController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoContenidoById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 404 not found resource
// @router / [get]
func (c *TipoContenidoController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllTipoContenido(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *TipoContenidoController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoContenido{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateTipoContenidoById(&v); err == nil {
...
// @Failure 404 not found resource
// @router /:id [delete]
func (c *TipoContenidoController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoContenido(id); err == nil {
