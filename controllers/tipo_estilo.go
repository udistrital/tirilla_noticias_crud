...
type TipoEstiloController struct {
	beego.Controller
}

// URLMapping ...
func (c *TipoEstiloController) URLMapping() {
...
// @Param	body		body 	models.TipoEstilo	true		"body for TipoEstilo content"
// @Success 201 {int} models.TipoEstilo
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *TipoEstiloController) Post() {
	var v models.TipoEstilo
	v.FechaCreacion = time_bogota.TiempoBogotaFormato()
	v.FechaModificacion = time_bogota.TiempoBogotaFormato()
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoEstilo(&v); err == nil {
...
// @Success 200 {object} models.TipoEstilo
// @Failure 404 not found resource
// @router /:id [get]
func (c *TipoEstiloController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoEstiloById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 404 not found resource
// @router / [get]
func (c *TipoEstiloController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllTipoEstilo(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *TipoEstiloController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoEstilo{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateTipoEstiloById(&v); err == nil {
...
// @Failure 404 not found resource
// @router /:id [delete]
func (c *TipoEstiloController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoEstilo(id); err == nil {
