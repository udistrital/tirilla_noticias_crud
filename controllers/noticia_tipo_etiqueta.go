...
type NoticiaTipoEtiquetaController struct {
	beego.Controller
}

// URLMapping ...
func (c *NoticiaTipoEtiquetaController) URLMapping() {
...
// @Param	body		body 	models.NoticiaTipoEtiqueta	true		"body for NoticiaTipoEtiqueta content"
// @Success 201 {int} models.NoticiaTipoEtiqueta
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *NoticiaTipoEtiquetaController) Post() {
	var v models.NoticiaTipoEtiqueta
	v.FechaCreacion = time_bogota.TiempoBogotaFormato()
	v.FechaModificacion = time_bogota.TiempoBogotaFormato()
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddNoticiaTipoEtiqueta(&v); err == nil {
...
// @router /:id [get]
func (c *NoticiaTipoEtiquetaController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetNoticiaTipoEtiquetaById(id)
	if err != nil {
		logs.Error(err)
...
// @Failure 404 not found resource
// @router / [get]
func (c *NoticiaTipoEtiquetaController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllNoticiaTipoEtiqueta(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
// @Failure 400 the request contains incorrect syntax
// @router /:id [put]
func (c *NoticiaTipoEtiquetaController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.NoticiaTipoEtiqueta{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		v.FechaModificacion = time_bogota.TiempoBogotaFormato()
		if err := models.UpdateNoticiaTipoEtiquetaById(&v); err == nil {
...
// @Failure 404 not found resource
// @router /:id [delete]
func (c *NoticiaTipoEtiquetaController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteNoticiaTipoEtiqueta(id); err == nil {
